...
class Variable final : public Expression, public ExpressionFactory<Variable> {
  public:
...
class Sum final : public TwoOperand, public ExpressionFactory<Sum> {
  public:
...
class Product final : public TwoOperand, public ExpressionFactory<Product> {
  public:
    using TwoOperand::TwoOperand;
